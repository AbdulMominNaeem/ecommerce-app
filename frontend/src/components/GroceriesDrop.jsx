...
const defaultItems = ['Flour and Rice', 'Grains and Sugars', 'Oils and Ghee', 'Spices']

export default function GroceriesDrop({ label = 'Groceries', items = defaultItems, onSelect }) {
  return (
