...
export const CategoryManagement = () => {
    ...
    const category = categoryJson ? JSON.parse(categoryJson) : null;
    ...
    const startEditing = (category) => {
        ...
        console.log("Selected image:", category.image);

        setCurrentItem(category);
        setNewData({ ...category });

        // IMPORTANT: use the image of THIS category
        setPreview(formatAvatarUrl(category.image));
    ...
    const getAll = async () => {
        try {
            ...
            toast.success(data?.message || "Successfully Fetched All Category!");
            setLoading(false);
        } catch (error) {
            setLoading(false);
    ...
    const handleDeleteCategory = async (category) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:3001/category/delete", {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
    ...
    const submitUpdate = async (e) => {
        ...
        formData.append("categoryImg", newData.image);
        ...
        try {
            ...
            const response = await fetch("http://localhost:3001/category/updatebyid", {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${token}`,
                },
                        ...
                        <tbody className="mt-10 h-80 divide-y overflow-auto divide-gray-100 border border-gray-100">
                            ...
                            {Category.map((category) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <Trash className="cursor-pointer hover:text-gray-700 hover:fill-red-300" onClick={() => handleDeleteCategory(category)} disabled={!currentItem}>Delete category</Trash>
